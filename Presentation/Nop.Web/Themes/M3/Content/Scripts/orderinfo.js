...
$(function () {
    ...
    switch (orderstates) {
        case "等待付款":
            ...
            if (orderid) {
                $('#pay-button').prepend('<a  href="/pay/certification' + orderid + '/' + $Maticsoft.CurrentArea + '"  > <img  src="/Areas/Shop/Themes/M3/Content/images/btn_pay.gif" width="46" height="25" style="display: inline;"> </a>');
            }
            break;
        case "正在处理":
        case "等待处理":
